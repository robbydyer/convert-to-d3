...
## Usage:
## converted_json = ConvertToD3(my_json)  => Returns a string of converted JSON
...
class ConvertToD3
    ...
    ## Singleton class. No need to allow instances of this class
    class << self
    ...
    ## Declare our class methods as private (except convert)
    private_class_method :new, :convert_string, :start_convert, :convert_hash, :convert_array
